        ...
        <Row>
          <div className='main-img d-flex align-items-center'>
            <div className="black-box p-5 ms-4 text-white">
              ...
              <h1 className='fw-blod mb-3'>THE MANY AUTO REPAIR SERVICES WE OFFER</h1>
              ...
              service.map((el, index) => {
                return <div className="col-lg-3 col-sm-6 col-12" key={index} onClick={card} >
                  <Card className='p-0 box pos-rel '>
                    ...
                    <a href="/customer-login" className="text-white hov  fw-bold p-3">Book Now</a>
                  </Card>
                </div>
              })
            }
        ...
        <Container className=''>
          <Row>
            <div className='text-white text-center pb-3'>
              <h1 className='fs-50'>TESTI<span className='fs-1 mt-2 icon-color'> MON</span> IALS <PiArrowBendRightDownFill className='fs-1 mt-2 icon-color' /> </h1>
            </div>
          </Row>
          <Row>
