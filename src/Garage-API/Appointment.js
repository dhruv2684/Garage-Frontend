...
const Appointment = () => {
    ...
    return (
        <div className='d-flex justify-content-center align-items-center mt-4 mb-5 ms-3 me-3'>
            <div className="box-1">
                ...
                <Formik
                    ...
                    onSubmit={async (values) => {
                        axios.post('https://garage-api-1vrb.onrender.com/appointment/create', values,
                            {
                                headers: {
