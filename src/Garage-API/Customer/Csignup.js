            ...
            <div className="box-1">
                ...
                <Formik
                    ...
                    onSubmit={async (values) => {
                        axios.post('https://garage-api-1vrb.onrender.com/customer/signup', values)
                            .then((res) => {
                    ...
                    <Form className='d-md-flex flex-column text-center'>
                        <div className="d-md-flex">
                            ...
                            <div className='ps-2 pe-2'>
                                ...
                                <label htmlFor="password" className='fw-bold'>password :</label><br />
