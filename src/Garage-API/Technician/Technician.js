...
const Technician = () => {
  ...
  return (
    <div>
      ...
      <Container fluid className=" pt-lg-5 pt-3 pb-lg-5mt-5 p-0 bg-lite text-white">
        <Container className="">
      ...
      <Container fluid className='pb-5 pt-5 ps-0 pe-0 bg-lite'>
        <Container>
          <Row className='g-3'>
            {
              appoinment.map((el, index) => {
                return <div className="col-md-3 col-sm-6 col-12" key={index} onClick={card}>
                  <Card style={{ width: '' }} className=' box-card text-center'>
                    <Card.Body>
                      <Card.Title className='home-red'>----- Technician -----</Card.Title>
                      <Card.Text className='mb-0 fs-3'>{el.appointmentDate}</Card.Text>
